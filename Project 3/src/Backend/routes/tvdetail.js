...
router.get('/:id',function(req,res){
    ...
    let url = "https://api.themoviedb.org/3/tv/"+id+"?api_key=3e6617a08bfe9d385972f79ca39f3f39&languag e=en-US&page=1";
    axios.get(url).then(curmovie =>{
     var data = [];
     var cut ={};
     cut["title"] = curmovie.data["name"];
     var tt = [];
     cut["genres"] = tt;
     ...
     cut["first_air_date"]=curmovie.data["first_air_date"];
     cut["runtime"] = curmovie.data["episode_run_time"][0];
