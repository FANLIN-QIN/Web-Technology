...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public CustomAdapter(Context context,ArrayList<TpmData> personImage,ArrayList personID,ArrayList personNames){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.topmovie, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        String wlist = "{\"id\":"+ personIDs.get(position).toString() +",\"path\":\"" + tpItem.getImgUrl() +"\",\"type\":\"movie\""+ ",\"title\":\"" + personNames.get(position).toString()+"\"}";

        TextView pop = (TextView) holder.itemView.findViewById(R.id.popclick);
        ...
        ImageView ima = (ImageView) holder.itemView.findViewById(R.id.topimage);
