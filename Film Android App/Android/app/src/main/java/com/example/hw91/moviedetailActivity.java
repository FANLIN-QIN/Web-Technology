...
public class moviedetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTheme(R.style.Theme_HW91);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moviedetail);

        Intent intent = getIntent();
        String mid = intent.getStringExtra("MOVIE_ID");
        String name_toast = intent.getStringExtra("MOVIE_name");
        String path = intent.getStringExtra("MOVIE_path");


        RequestQueue queue = Volley.newRequestQueue(this);
        String url ="https://sample666.wn.r.appspot.com/apis/mvedio9/"+mid;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ImageView imageView = findViewById(R.id.playimage);
        ...
        String detailurl ="https://sample666.wn.r.appspot.com/apis/mdetail9/"+mid;
        ...
        StringRequest stringRequest1 = new StringRequest(Request.Method.GET, detailurl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        TextView text = findViewById(R.id.yearmovie);
                        text.setText(list.get(0).get("release_date").toString());
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
        ...
        String overviewurl ="https://sample666.wn.r.appspot.com/apis/mdetailo/"+mid;
        // Request a string response from the provided URL.
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, overviewurl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        List<HashMap> list = new ArrayList<HashMap>();
                        list.add(m);
                        TextView text = findViewById(R.id.movie_overview);
        ...
        String genresurl ="https://sample666.wn.r.appspot.com/apis/mdetailg/"+mid;
        ...
        StringRequest stringRequest3 = new StringRequest(Request.Method.GET, genresurl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        List<HashMap> list = new ArrayList<HashMap>();
                        list.add(m);
                        TextView text = findViewById(R.id.genres);
                        text.setText(list.get(0).get("genres").toString());
                    }
                }, new Response.ErrorListener() {
            @Override
        ...
        TextView add = findViewById(R.id.adddetail);
        TextView remove = findViewById(R.id.removewdtail);
        ...
        if (a1 != null){
            try {
                ...
                for (int i = 0; i < watchlistJSONArray.length(); i++) {
                    ...
                    if (itemJSON.getString("id").equals(mid)) {
        ...
        String wlist = "{\"id\":"+ mid +",\"path\":\"" + path +"\",\"type\":\"movie\""+ ",\"title\":\"" + name_toast+"\"}";
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(moviedetailActivity.this,""+ name_toast+ "was added to Watchlist", Toast.LENGTH_SHORT).show();
                remove.setVisibility(View.VISIBLE);
                add.setVisibility(View.GONE);
            }
        });
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(moviedetailActivity.this, ""+ name_toast + "was removed from Watchlist", Toast.LENGTH_SHORT).show();
        ...
        TextView mfb = findViewById(R.id.detailfb);
        mfb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri1 = Uri.parse("https://www.facebook.com/sharer/sharer.php?u=https://www.themoviedb.org/movie/"+mid+"?language=en-US");
                Intent intent1 = new Intent(Intent.ACTION_VIEW,uri1);
                startActivity(intent1);
            }
        });

        TextView mtw = findViewById(R.id.detailtw);
        mtw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri2 = Uri.parse("https://twitter.com/intent/tweet?url=https://www.themoviedb.org/movie/"+mid+"?language=en-US");
                Intent intent2 = new Intent(Intent.ACTION_VIEW,uri2);
                startActivity(intent2);
            }
        });

        String casturl ="https://sample666.wn.r.appspot.com/apis/mcast9/"+mid;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.length()>2) {
                            ...
                            RecyclerView recyclerView = (RecyclerView) findViewById(R.id.Castrecycle);
                            // set a GridLayoutManager with 3 number of columns , horizontal gravity and false value for reverseLayout to show the items from start to end
                            GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 3);
                            recyclerView.setLayoutManager(gridLayoutManager); // set LayoutManager to RecyclerView
                            //  call the constructor of CustomAdapter to send the reference and data to Adapter
                            CastmAdapter castmAdapter = new CastmAdapter(moviedetailActivity.this, personImages, personNames);
                            recyclerView.setAdapter(castmAdapter); // set the Adapter to RecyclerView
                        }
                        if (response.length() == 2){
                            TextView retirle = findViewById(R.id.mcasttitle);
                            retirle.setVisibility(View.GONE);
                            RecyclerView review = findViewById(R.id.Castrecycle);
        ...
        String reviewurl ="https://sample666.wn.r.appspot.com/apis/mreview9/"+mid;
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.length() > 10) {
                            ...
                            if (size > 1) {
                                ...
                                // get the reference of RecyclerView
                                RecyclerView recyclerView = (RecyclerView) findViewById(R.id.reviewrecycle);
                                // set a GridLayoutManager with 3 number of columns , horizontal gravity and false value for reverseLayout to show the items from start to end
                                GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 1);
                                recyclerView.setLayoutManager(gridLayoutManager); // set LayoutManager to RecyclerView
                                //  call the constructor of CustomAdapter to send the reference and data to Adapter
                                ReviewAdapter reviewAdapter = new ReviewAdapter(moviedetailActivity.this, personNames, rating,content);
                        ...
                        if (response.length() == 2){
                            TextView retirle = findViewById(R.id.retitle);
                            retirle.setVisibility(View.GONE);
                            RecyclerView review = findViewById(R.id.reviewrecycle);
                            review.setVisibility(View.GONE);
                        }
        ...
        String recomurl ="https://sample666.wn.r.appspot.com/apis/mrecom9/"+mid;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.length()> 4) {
                            ...
                            // get the reference of RecyclerView
                            RecyclerView recyclerView = (RecyclerView) findViewById(R.id.mrecommrecycleView);
                            ...
                            recyclerView.setLayoutManager(gridLayoutManager); // set LayoutManager to RecyclerView
                            //  call the constructor of CustomAdapter to send the reference and data to Adapter
                            MrecomAdapter mrecomAdapter = new MrecomAdapter(moviedetailActivity.this, personImages, personID);
                            recyclerView.setAdapter(mrecomAdapter); // set the Adapter to RecyclerView
                        }
                        if (response.length() == 4){
                            TextView retirle = findViewById(R.id.mrecomtitle);
                            retirle.setVisibility(View.GONE);
                            RecyclerView review = findViewById(R.id.mrecommrecycleView);
                            review.setVisibility(View.GONE);
                        }
                    }
                }, new Response.ErrorListener() {
