...
public class PopumAdapter extends RecyclerView.Adapter<PopumAdapter.MyViewHolder> {
    private final ArrayList<PomData> personImages;
    ArrayList personIDs;
    ArrayList personNames;
    Context context;

    public PopumAdapter(Context context,ArrayList<PomData> personImage,ArrayList personID,ArrayList personNames){
    ...
    @Override
    public PopumAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // infalte the item Layout
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.pomovie, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PopumAdapter.MyViewHolder vh = new PopumAdapter.MyViewHolder(v); // pass the view to View Holder
    ...
    @Override
    public void onBindViewHolder(PopumAdapter.MyViewHolder holder, final int position) {
        ...
        String wlist = "{\"id\":"+ personIDs.get(position).toString() +",\"path\":\"" + poItem.getImgUrl() +"\",\"type\":\"movie\""+ ",\"title\":\"" + personNames.get(position).toString()+"\"}";


        TextView pop = (TextView) holder.itemView.findViewById(R.id.pomclick);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            case R.id.opendb:
                                Uri uri = Uri.parse("https://www.themoviedb.org/movie/"+personIDs.get(position)+"-the-bumblebee-flies-anyway?language=en-US");
                                Intent intent = new Intent(Intent.ACTION_VIEW,uri);
                                context.startActivity(intent);
                                break;
                            case R.id.sharefb:
                                Uri uri1 = Uri.parse("https://www.facebook.com/sharer/sharer.php?u=https://www.themoviedb.org/movie/"+personIDs.get(position)+"?language=en-US");
                                Intent intent1 = new Intent(Intent.ACTION_VIEW,uri1);
                                context.startActivity(intent1);
                                break;
                            case R.id.sharetw:
                                Uri uri2 = Uri.parse("https://twitter.com/intent/tweet?url=https://www.themoviedb.org/movie/"+personIDs.get(position)+"?language=en-US");
        ...
        ImageView ima = (ImageView) holder.itemView.findViewById(R.id.pomimage);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            image = itemView.findViewById(R.id.pomimage);
