...
public class TprTVAdapter extends RecyclerView.Adapter<TprTVAdapter.MyViewHolder>{
    private final ArrayList<TpmData> personImages;
    ArrayList personIDs;
    ArrayList personNames;
    Context context;

    public TprTVAdapter(Context context,ArrayList<TpmData> personImage,ArrayList personID,ArrayList personNames){
    ...
    @Override
    public TprTVAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // infalte the item Layout
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.toptv, parent, false);
        // set the view's size, margins, paddings and layout parameters
        TprTVAdapter.MyViewHolder vh = new TprTVAdapter.MyViewHolder(v); // pass the view to View Holder
        context = parent.getContext();
        return vh;
    }

    @Override
    public void onBindViewHolder(TprTVAdapter.MyViewHolder holder, final int position) {
        ...
        String wlist = "{\"id\":"+ personIDs.get(position).toString() +",\"path\":\"" + tpItem.getImgUrl() +"\",\"type\":\"tv\""+ ",\"title\":\"" + personNames.get(position).toString()+"\"}";


        TextView pop = (TextView) holder.itemView.findViewById(R.id.popclicktv);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            image = itemView.findViewById(R.id.topimagetv);
